<?php
namespace SwiftOtter\OrderExport\Console\Command\OrderExport;

/**
 * Interceptor class for @see \SwiftOtter\OrderExport\Console\Command\OrderExport
 */
class Interceptor extends \SwiftOtter\OrderExport\Console\Command\OrderExport implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\SwiftOtter\OrderExport\Model\HeaderDataFactory $headerDataFactory, \SwiftOtter\OrderExport\Action\ExportOrder $exportOrder, ?string $name = null)
    {
        $this->___init();
        parent::__construct($headerDataFactory, $exportOrder, $name);
    }
